...
def buscar_y_exportar_a_csv(termino_busqueda, max_resultados=5, archivo_csv="resultados_ncbi.csv"):
    try:
...
def ejecutar_busqueda_periodica(buscar_y_exportar_a_csv,intervalos_horas=168):
    while True:
        print(f"INICIANDO busqueda en PudMed: {datetime.now()}")
        buscar_y_exportar_a_csv(termino_de_busqueda,max_resultados=5, archivo_csv="resultados_ncbi.csv")
        time.sleep(intervalos_horas * 3600)
...
buscar_y_exportar_a_csv(termino_de_busqueda, max_resultados=168)
#Busqueda periodica 

ejecutar_busqueda_periodica(buscar_y_exportar_a_csv, intervalos_horas=168)